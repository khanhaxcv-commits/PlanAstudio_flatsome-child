            ...
            <div class="col-lg-12">
                ...
                <div class="about-facility-list">
                    ...
                    <div class="about-facility-item wow fadeInUp">
                        <div class="icon-box">
                            <img src="<?php echo esc_url($theme_uri . '/assets/images/icon-about-facility-1.svg'); ?>" alt="">
                        </div>
                    ...
                    <div class="about-facility-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="icon-box">
                            <img src="<?php echo esc_url($theme_uri . '/assets/images/icon-about-facility-2.svg'); ?>" alt="">
                        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="vision-mission-box">
                    ...
                    <div class="vision-mission-item wow fadeInUp">
                        <div class="icon-box">
                            <img src="<?php echo esc_url($theme_uri . '/assets/images/icon-our-vision.svg'); ?>" alt="">
                        </div>
                    ...
                    <div class="vision-mission-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="icon-box">
                            <img src="<?php echo esc_url($theme_uri . '/assets/images/icon-our-mission.svg'); ?>" alt="">
                        </div>
                        <div class="vision-mission-content">
                            <h3>our mission</h3>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="best-selling-content">
                    ...
                    <div class="best-selling-content-img">
                        <figure class="image-anime reveal">
                            <img src="<?php echo esc_url($theme_uri . '/assets/images/best-selling-img-1.jpg'); ?>" alt="">
                        </figure>
                    </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="best-selling-iamge">
                    <figure class="image-anime reveal">
                        <img src="<?php echo esc_url($theme_uri . '/assets/images/best-selling-img-2.jpg'); ?>" alt="">
                    </figure>
                </div>
                ...
                <div class="team-member-item wow fadeInUp">
                    ...
                    <div class="team-image">
                        <a href="team-single.html" data-cursor-text="View">
                            <figure class="image-anime">
                                <img src="<?php echo esc_url($theme_uri . '/assets/images/team-1.jpg'); ?>" alt="">
                            </figure>
                        </a>

                        <!-- Team Readmore Button Start -->
                        <div class="team-readmore-btn">
                            <a href="#"><img src="<?php echo esc_url($theme_uri . '/assets/images/arrow-white.svg'); ?>" alt=""></a>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="team-member-item wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="team-image">
                        <a href="team-single.html" data-cursor-text="View">
                            <figure class="image-anime">
                                <img src="<?php echo esc_url($theme_uri . '/assets/images/team-2.jpg'); ?>" alt="">
                            </figure>
                        </a>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="team-member-item wow fadeInUp" data-wow-delay="0.4s">
                    ...
                    <div class="team-image">
                        <a href="team-single.html" data-cursor-text="View">
                            <figure class="image-anime">
                                <img src="<?php echo esc_url($theme_uri . '/assets/images/team-3.jpg'); ?>" alt="">
                            </figure>
                        </a>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5">
                ...
                <div class="our-faqs-image">
                    <figure class="image-anime reveal">
                        <img src="<?php echo esc_url($theme_uri . '/assets/images/faqs-image.jpg'); ?>" alt="">
                    </figure>
                </div>
                <!-- Our Faq Image End -->
            </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="client-logo">
                                        <img src="<?php echo esc_url($theme_uri . '/assets/images/client-logo-1.svg'); ?>" alt="">
                                    </div>
                                </div>
                                <!-- Client Logo End -->
                                ...
                                <div class="swiper-slide">
                                    <div class="client-logo">
                                        <img src="<?php echo esc_url($theme_uri . '/assets/images/client-logo-2.svg'); ?>" alt="">
                                    </div>
                                </div>
                                <!-- Client Logo End -->
                                ...
                                <div class="swiper-slide">
                                    <div class="client-logo">
                                        <img src="<?php echo esc_url($theme_uri . '/assets/images/client-logo-3.svg'); ?>" alt="">
                                    </div>
                                </div>
                                <!-- Client Logo End -->
                                ...
                                <div class="swiper-slide">
                                    <div class="client-logo">
                                        <img src="<?php echo esc_url($theme_uri . '/assets/images/client-logo-4.svg'); ?>" alt="">
                                    </div>
                                </div>
                                <!-- Client Logo End -->
